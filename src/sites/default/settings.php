...
$conf['cache_backends'][] = 'modules/contrib/authcache/authcache.cache.inc';
$conf['cache_backends'][] = 'modules/contrib/authcache/modules/authcache_builtin/authcache_builtin.cache.inc';
